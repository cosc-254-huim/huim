...
for i in {0..2}; do
    ...
    echo "minutil (DB_Utility) (Two-Phase): $db_utility_minutil"
    ...
    echo "minutil (CHESS) (Two-Phase): $chess_minutil"
    ...
    echo "minutil (FOODMART) (Two-Phase): $foodmart_minutil"
    ...
    echo "minutil (BMS) (Two-Phase): $bms_minutil"
